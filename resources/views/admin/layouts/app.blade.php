        ...
        <nav class="nav__sidebar">
            <div> 
                ...
                <div class="nav_list__sidebar">
                    <li class="{{'admin/main' == request()->path() ? 'active' : ''}}">
                        <a href="{{ route('admin.dashboard') }}" class="nav_link__sidebar"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name__sidebar">Dashboard</span> </a> 
                    </li>
                    <li class="{{'admin/dashboard' == request()->path() ? 'active' : ''}}">
                        <a href="{{ route('admin.borrowers.list') }}" class="nav_link__sidebar"> <i class='bx bxs-user-detail'></i> <span class="nav_name__sidebar">Members List</span> </a> 
                    </li>
                    <li class="{{'admin/LoanManagement' == request()->path() ? 'active' : ''}}">
                        <a href="{{ route('admin.LoanManagement') }}" class="nav_link__sidebar"> <i class='bx bx-wallet-alt nav_icon'></i> <span class="nav_name">Loan Applications</span> </a> 
                    </li>
                    <li class="{{'admin/MemberHistory1' == request()->path() ? 'active' : ''}}">
                        <a href="{{ route('admin.MemberHistory1') }}" class="nav_link__sidebar"> <i class='bx bx-history'></i> <span class="nav_name">Payment Summary</span> </a> 
                    </li>
                    <li class="{{'admin/MemberHistory' == request()->path() ? 'active' : ''}}">
                        <a href="{{ route('admin.MemberHistory') }}" class="nav_link__sidebar"> <i class='bx bx-history'></i> <span class="nav_name">Loan History</span> </a> 
                    </li>
                    <li class="{{'admin/account_setting' == request()->path() ? 'active' : ''}}">
                        <a href="{{ route('admin.account_setting') }}" class="nav_link__sidebar"> <i class='bx bxs-cog'></i> <span class="nav_name">Account Setting</span> </a> 
                    </li>
                    <li class="{{'admin/viewReports' == request()->path() ? 'active' : ''}}">
                        <a href="{{ route('admin.viewReports') }}" class="nav_link__sidebar"> <i class='bx bxs-bug'></i> <span class="nav_name">Reports</span> </a> 
                    </li>
...
<script type="text/javascript">
    $('#searchToInpect').on('keyup',function(){
        $value = $(this).val();
        $.ajax({
            url:"{{ route('admin.searchToInspect')}}",
            method:'GET',
            data: {'searchToInpect':$value},

            success:function(data){
                console.log(data);
                $('.client-data-inspect').html(data);
            }
        });
    })
</script>
