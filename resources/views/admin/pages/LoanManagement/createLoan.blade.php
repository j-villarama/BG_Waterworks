            ...
            <div class="card_custom">
               <nav class="nav nav-tabs">
                    <button type="button" class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab-client-info">
                        <strong style="color: #073b3a">Create Loan</strong>
                    </button>
               ...
               <form name="FormName" action="{{ route('admin.create_loan.post') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="tab-pane show active fade" id="tab-client-info">
                            <div class="tab__content-flex d-flex">
                                <div class="form-floating client__info-section1">
                                    ...
                                    <div class="form-floating">
                                        <select required class="form-select" id="selected_name" aria-label="Floating label select example" name="customer_name">
                                            <option selected value="{{ null }}" disabled>Select Member</option>
                                            @foreach ($name as $key => $name)
                                                {{-- <option value="{{ $name->id }}" {{ ( $selectedID == $name->id) ? 'selected' : '' }}> --}}
                                        ...
                                        <label for="floatingSelect">Member Name</label>
                                    </div>
                                ...
                                <div class="client__info-section2">
                                    <div class="form-floating">
                                        <input type="text" class="form-control form-control-sm" readonly="true" id="shared_capital" name="" placeholder="Shared Capital">
                                        <label for="floatingInput">Shared Capital</label>
                                    </div>
                                    <br>

                                    <div class="form-floating">
                                        <input type="text" class="form-control form-control-sm" readonly="true" id="savings_deposit" name="" placeholder="Savings Deposit">
                                        <label for="floatingInput">Savings Deposit</label>
                                    </div>
                                    <br>

                                    <div class="form-floating">
                                        <input type="text" class="form-control form-control-sm" readonly="true" id="interest" name="" placeholder="Interest">
                                        <label for="floatingInput">Interest</label>
                                    </div>
                                    <br>

                                    <div class="form-floating">
                                        <input type="text" class="form-control form-control-sm" readonly="true" id="service_fee" name="" placeholder="Service Fee">
                                        <label for="floatingInput">Service Fee</label>
                                    </div>
                                    <br>

                                    <div class="form-floating">
                                        <input type="text" class="form-control form-control-sm" readonly="true" id="miscellaneous_fee" name="" placeholder="Miscellaneous Fee">
                                        <label for="floatingInput">Miscellaneous Fee</label>
                                    </div>
                                    <br>

                                    <div class="form-floating">
                                        <input type="text" required class="form-control form-control-sm" readonly="true" id="payment_term_result" name="payment_term_result" placeholder="Payment Term">
                                        <label id="ppw" for="floatingInput">Payment Term</label>
                                    </div>
                                    <br>

                                    <div class="form-floating">
                                        <input type="text" class="form-control form-control-sm" readonly="true" id="net_proceeds" name="" placeholder="Net Proceeds">
