    ...
    <div class="card_custom">
        <div class="card-header ">
            <div class="card-header-text">
                <span style="color:#073b3a;"><strong>LOAN APPLICATIONS</strong></span>
            </div>
                ...
                <table class="table table-striped">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col">Loan Payment Terms</th>
                    ...
                    <tbody>
                        @foreach($loanlist as $data)
                            <tr>
                                ...
                                <td name="status">{{ $data->current_status }}</td>
                                <td class="actions">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><span data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                <a href="#" class="btn-sm" data-bs-toggle="modal" data-bs-target="#DeleteClient_{{ $data->id }}" data-bs-placement="top" title="Delete"><i class='bx bx-trash bx-xs py-2'><span class="px-1" style="font-family: sans-serif">View Reason</span></i></a>
                                            </span></li>
                                            @endif
