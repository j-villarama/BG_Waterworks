            ...
            <div class="card_custom">
               <nav class="nav nav-tabs">
                    <button type="button" class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab-client-info">
                        <strong style="color: #073b3a">Mark Customer As Complete</strong>
                    </button>
               ...
               <form name="FormName" action="{{ url('admin/complete_update/'.$loansd->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
